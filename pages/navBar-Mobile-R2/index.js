...
function ButtonForLoggedSuccessfully() {
  console.log('ButtonForLoggedSuccessfully')
  return (
    <Button
      tabIndex={0}
      color="primary"
...
export default function Dropdown() {
  ...
  const NavigationMenu = () => {
    // OK to be called everytimeconsole.log('NavigationMenu')
  ...
  const ButtonOnEmptyState = () => {
    console.log('emptyStatex2')
    return useMemo(() => {
      console.log('emptyStatex3')
      return (
        <>
          <Button
            tabIndex={0}
  ...
  const TheLoginButton = useMemo(() => {
    ...
    return UserIsAttemptinglog
      ? ButtonForLoggedSuccessfully
      : ButtonOnEmptyState
  }, [UserIsAttemptinglog])
  ...
  const NavigationMenuLoggedIn = useMemo(() => {
    console.log('NavigationMenuLoggedIn')
  ...
  function loggedOut() {
    /// ///////////////////// this one is called 4 times on REF
